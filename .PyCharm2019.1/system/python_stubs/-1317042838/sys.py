...
executable = '/var/www/newsbytes/CPP/venv/bin/python'

exec_prefix = '/var/www/newsbytes/CPP/venv'
...
prefix = '/var/www/newsbytes/CPP/venv'
...
path = [
    ...
    '/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages',
    '/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/setuptools-40.8.0-py3.6.egg',
    '/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pip-19.0.3-py3.6.egg',
]

path_hooks = [
    None, # (!) real value is "<class 'zipimport.zipimporter'>"
    None, # (!) real value is '<function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0x7f3ceeaeb6a8>'
]
