...
openssl_md_meth_names = None # (!) real value is "frozenset({'SHA', 'MD4', 'SHA224', 'DSA', 'MD5', 'sha256', 'sha224', 'sha', 'SHA1', 'md4', 'SHA256', 'RIPEMD160', 'SHA512', 'SHA384', 'whirlpool', 'sha384', 'DSA-SHA', 'md5', 'ripemd160', 'sha512', 'sha1', 'ecdsa-with-SHA1', 'dsaWithSHA', 'dsaEncryption'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7a7733a7f0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7a7733a7f0>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
