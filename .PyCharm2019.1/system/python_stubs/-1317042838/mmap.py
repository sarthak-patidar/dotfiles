...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f97888f5828>'

__spec__ = None # (!) real value is "ModuleSpec(name='mmap', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f97888f5828>, origin='/usr/lib/python3.6/lib-dynload/mmap.cpython-36m-x86_64-linux-gnu.so')"
