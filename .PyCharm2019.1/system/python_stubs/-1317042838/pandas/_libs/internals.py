...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/internals.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
class BlockPlacement(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f41db422cf0>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f41db4497b8>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.internals', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f41db4497b8>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/internals.cpython-36m-x86_64-linux-gnu.so')"
