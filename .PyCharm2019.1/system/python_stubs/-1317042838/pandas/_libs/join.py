...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/join.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff2802abb00>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.join', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff2802abb00>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/join.cpython-36m-x86_64-linux-gnu.so')"
