...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/json.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f1e40b3c630>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f1e40b3c630>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/json.cpython-36m-x86_64-linux-gnu.so')"
