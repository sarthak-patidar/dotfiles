...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/timezones.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
class _dateutil_tzutc(__datetime.tzinfo):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.tz.tz\', \'__doc__\': "\\n    This is a tzinfo object that represents the UTC time zone.\\n\\n    **Examples:**\\n\\n    .. doctest::\\n\\n        >>> from datetime import *\\n        >>> from dateutil.tz import *\\n\\n        >>> datetime.now()\\n        datetime.datetime(2003, 9, 27, 9, 40, 1, 521290)\\n\\n        >>> datetime.now(tzutc())\\n        datetime.datetime(2003, 9, 27, 12, 40, 12, 156379, tzinfo=tzutc())\\n\\n        >>> datetime.now(tzutc()).tzname()\\n        \'UTC\'\\n\\n    .. versionchanged:: 2.7.0\\n        ``tzutc()`` is now a singleton, so the result of ``tzutc()`` will\\n        always return the same object.\\n\\n        .. doctest::\\n\\n            >>> from dateutil.tz import tzutc, UTC\\n            >>> tzutc() is tzutc()\\n            True\\n            >>> tzutc() is UTC\\n            True\\n    ", \'utcoffset\': <function tzutc.utcoffset at 0x7f7417154f28>, \'dst\': <function tzutc.dst at 0x7f7417157048>, \'tzname\': <function tzutc.tzname at 0x7f74171570d0>, \'is_ambiguous\': <function tzutc.is_ambiguous at 0x7f7417157158>, \'fromutc\': <function tzutc.fromutc at 0x7f7417157268>, \'__eq__\': <function tzutc.__eq__ at 0x7f74171572f0>, \'__hash__\': None, \'__ne__\': <function tzutc.__ne__ at 0x7f7417157378>, \'__repr__\': <function tzutc.__repr__ at 0x7f7417157400>, \'__reduce__\': <method \'__reduce__\' of \'object\' objects>, \'__dict__\': <attribute \'__dict__\' of \'tzutc\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'tzutc\' objects>, \'_TzSingleton__instance\': tzutc()})'
    __hash__ = None
...
class _pytz_BaseTzInfo(__datetime.tzinfo):
    ...
    _tzname = None
    _utcoffset = None
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pytz.tzinfo', '_utcoffset': None, '_tzname': None, 'zone': None, '__str__': <function BaseTzInfo.__str__ at 0x7f7417f368c8>, '__dict__': <attribute '__dict__' of 'BaseTzInfo' objects>, '__weakref__': <attribute '__weakref__' of 'BaseTzInfo' objects>, '__doc__': None})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7417239390>'

__pyx_capi__ = {
    'get_dst_info': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7f741721ecc0>'
    'get_timezone': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x7f741721ec00>'
    'get_utcoffset': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *)" at 0x7f741721ec60>'
    'is_fixed_offset': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7f741721ec90>'
    'is_tzlocal': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7f741721eb40>'
    'is_utc': None, # (!) real value is '<capsule object "int (PyObject *, int __pyx_skip_dispatch)" at 0x7f741721e8d0>'
    'maybe_get_tz': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x7f741721ec30>'
    'treat_tz_as_dateutil': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7f741721eba0>'
    'treat_tz_as_pytz': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7f741721eb70>'
    'tz_compare': None, # (!) real value is '<capsule object "int (PyObject *, PyObject *, int __pyx_skip_dispatch)" at 0x7f741721ebd0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timezones', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7417239390>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/timezones.cpython-36m-x86_64-linux-gnu.so')"
