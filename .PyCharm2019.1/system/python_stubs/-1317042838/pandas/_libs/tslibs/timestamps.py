...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/timestamps.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import warnings as warnings # /usr/lib/python3.6/warnings.py
...
class RoundTo(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.timestamps\', \'__doc__\': \'\\n    enumeration defining the available rounding modes\\n\\n    Attributes\\n    ----------\\n    MINUS_INFTY\\n        round towards -?, or floor [2]_\\n    PLUS_INFTY\\n        round towards +?, or ceil [3]_\\n    NEAREST_HALF_EVEN\\n        round to nearest, tie-break half to even [6]_\\n    NEAREST_HALF_MINUS_INFTY\\n        round to nearest, tie-break half to -? [5]_\\n    NEAREST_HALF_PLUS_INFTY\\n        round to nearest, tie-break half to +? [4]_\\n\\n\\n    References\\n    ----------\\n    .. [1] "Rounding - Wikipedia"\\n           https://en.wikipedia.org/wiki/Rounding\\n    .. [2] "Rounding down"\\n           https://en.wikipedia.org/wiki/Rounding#Rounding_down\\n    .. [3] "Rounding up"\\n           https://en.wikipedia.org/wiki/Rounding#Rounding_up\\n    .. [4] "Round half up"\\n           https://en.wikipedia.org/wiki/Rounding#Round_half_up\\n    .. [5] "Round half down"\\n           https://en.wikipedia.org/wiki/Rounding#Round_half_down\\n    .. [6] "Round half to even"\\n           https://en.wikipedia.org/wiki/Rounding#Round_half_to_even\\n    \', \'MINUS_INFTY\': <property object at 0x7f356c29ad18>, \'PLUS_INFTY\': <property object at 0x7f356c29ad68>, \'NEAREST_HALF_EVEN\': <property object at 0x7f356c29adb8>, \'NEAREST_HALF_PLUS_INFTY\': <property object at 0x7f356c29a408>, \'NEAREST_HALF_MINUS_INFTY\': <property object at 0x7f356c29a458>, \'__dict__\': <attribute \'__dict__\' of \'RoundTo\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'RoundTo\' objects>})'
...
class _Timestamp(__datetime.datetime):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f356c27ea50>'
...
class Timestamp(_Timestamp):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.timestamps\', \'__doc__\': "Pandas replacement for datetime.datetime\\n\\n    Timestamp is the pandas equivalent of python\'s Datetime\\n    and is interchangeable with it in most cases. It\'s the type used\\n    for the entries that make up a DatetimeIndex, and other timeseries\\n    oriented data structures in pandas.\\n\\n    Parameters\\n    ----------\\n    ts_input : datetime-like, str, int, float\\n        Value to be converted to Timestamp\\n    freq : str, DateOffset\\n        Offset which Timestamp will have\\n    tz : str, pytz.timezone, dateutil.tz.tzfile or None\\n        Time zone for time which Timestamp will have.\\n    unit : str\\n        Unit used for conversion if ts_input is of type int or float. The\\n        valid values are \'D\', \'h\', \'m\', \'s\', \'ms\', \'us\', and \'ns\'. For\\n        example, \'s\' means seconds and \'ms\' means milliseconds.\\n    year, month, day : int\\n        .. versionadded:: 0.19.0\\n    hour, minute, second, microsecond : int, optional, default 0\\n        .. versionadded:: 0.19.0\\n    nanosecond : int, optional, default 0\\n        .. versionadded:: 0.23.0\\n    tzinfo : datetime.tzinfo, optional, default None\\n        .. versionadded:: 0.19.0\\n\\n    Notes\\n    -----\\n    There are essentially three calling conventions for the constructor. The\\n    primary form accepts four parameters. They can be passed by position or\\n    keyword.\\n\\n    The other two forms mimic the parameters from ``datetime.datetime``. They\\n    can be passed by either position or keyword, but not both mixed together.\\n\\n    Examples\\n    --------\\n    Using the primary calling convention:\\n\\n    This converts a datetime-like string\\n    >>> pd.Timestamp(\'2017-01-01T12\')\\n    Timestamp(\'2017-01-01 12:00:00\')\\n\\n    This converts a float representing a Unix epoch in units of seconds\\n    >>> pd.Timestamp(1513393355.5, unit=\'s\')\\n    Timestamp(\'2017-12-16 03:02:35.500000\')\\n\\n    This converts an int representing a Unix-epoch in units of seconds\\n    and for a particular timezone\\n    >>> pd.Timestamp(1513393355, unit=\'s\', tz=\'US/Pacific\')\\n    Timestamp(\'2017-12-15 19:02:35-0800\', tz=\'US/Pacific\')\\n\\n    Using the other two forms that mimic the API for ``datetime.datetime``:\\n\\n    >>> pd.Timestamp(2017, 1, 1, 12)\\n    Timestamp(\'2017-01-01 12:00:00\')\\n\\n    >>> pd.Timestamp(year=2017, month=1, day=1, hour=12)\\n    Timestamp(\'2017-01-01 12:00:00\')\\n    ", \'fromordinal\': <classmethod object at 0x7f356c289320>, \'now\': <classmethod object at 0x7f356c2ee860>, \'today\': <classmethod object at 0x7f356c28dfd0>, \'utcnow\': <classmethod object at 0x7f356c28df98>, \'utcfromtimestamp\': <classmethod object at 0x7f356c29c8d0>, \'fromtimestamp\': <classmethod object at 0x7f356c29c908>, \'combine\': <classmethod object at 0x7f356c29c9b0>, \'__new__\': <cyfunction Timestamp.__new__ at 0x7f356c281f60>, \'_round\': <cyfunction Timestamp._round at 0x7f356c29f048>, \'round\': <cyfunction Timestamp.round at 0x7f356c29f100>, \'floor\': <cyfunction Timestamp.floor at 0x7f356c29f1b8>, \'ceil\': <cyfunction Timestamp.ceil at 0x7f356c29f270>, \'tz\': <property object at 0x7f356c29ae08>, \'__setstate__\': <cyfunction Timestamp.__setstate__ at 0x7f356c29f498>, \'__reduce__\': <cyfunction Timestamp.__reduce__ at 0x7f356c29f550>, \'to_period\': <cyfunction Timestamp.to_period at 0x7f356c29f608>, \'dayofweek\': <property object at 0x7f356c29acc8>, \'day_name\': <cyfunction Timestamp.day_name at 0x7f356c29f778>, \'month_name\': <cyfunction Timestamp.month_name at 0x7f356c29f830>, \'weekday_name\': <property object at 0x7f356c29ae58>, \'dayofyear\': <property object at 0x7f356c29aef8>, \'week\': <property object at 0x7f356c29af48>, \'weekofyear\': <property object at 0x7f356c29af48>, \'quarter\': <property object at 0x7f356c29af98>, \'days_in_month\': <property object at 0x7f356c2a0048>, \'daysinmonth\': <property object at 0x7f356c2a0048>, \'freqstr\': <property object at 0x7f356c2a0098>, \'is_month_start\': <property object at 0x7f356c2a00e8>, \'is_month_end\': <property object at 0x7f356c2a0138>, \'is_quarter_start\': <property object at 0x7f356c2a0188>, \'is_quarter_end\': <property object at 0x7f356c2a01d8>, \'is_year_start\': <property object at 0x7f356c2a0228>, \'is_year_end\': <property object at 0x7f356c2a0278>, \'is_leap_year\': <property object at 0x7f356c2a02c8>, \'tz_localize\': <cyfunction Timestamp.tz_localize at 0x7f356c2a1270>, \'tz_convert\': <cyfunction Timestamp.tz_convert at 0x7f356c2a1328>, \'astimezone\': <cyfunction Timestamp.tz_convert at 0x7f356c2a1328>, \'replace\': <cyfunction Timestamp.replace at 0x7f356c2a13e0>, \'isoformat\': <cyfunction Timestamp.isoformat at 0x7f356c2a1498>, \'_has_time_component\': <cyfunction Timestamp._has_time_component at 0x7f356c2a1550>, \'to_julian_date\': <cyfunction Timestamp.to_julian_date at 0x7f356c2a1608>, \'normalize\': <cyfunction Timestamp.normalize at 0x7f356c2a16c0>, \'__radd__\': <cyfunction Timestamp.__radd__ at 0x7f356c2a1778>, \'__dict__\': <attribute \'__dict__\' of \'Timestamp\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Timestamp\' objects>, \'min\': Timestamp(\'1677-09-21 00:12:43.145225\'), \'max\': Timestamp(\'2262-04-11 23:47:16.854775807\')})'
...
_no_input = None # (!) real value is '<object object at 0x7f357aabb9f0>'

_zero_time = None # (!) real value is 'datetime.time(0, 0)'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f356c2917f0>'

__pyx_capi__ = {
    'create_timestamp_from_ts': None, # (!) real value is '<capsule object "PyObject *(__pyx_t_5numpy_int64_t, npy_datetimestruct, PyObject *, PyObject *)" at 0x7f356c27e9c0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timestamps', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f356c2917f0>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/timestamps.cpython-36m-x86_64-linux-gnu.so')"
