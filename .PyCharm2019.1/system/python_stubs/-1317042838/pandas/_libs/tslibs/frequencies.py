...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/frequencies.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f946280d438>'

__pyx_capi__ = {
    'get_base_alias': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x7f9462801930>'
    'get_freq': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x7f9462801900>'
    'get_freq_code': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x7f94628018d0>'
    'get_freq_str': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6pandas_5_libs_6tslibs_11frequencies_get_freq_str *__pyx_optional_args)" at 0x7f9462801990>'
    'get_rule_month': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_6pandas_5_libs_6tslibs_11frequencies_get_rule_month *__pyx_optional_args)" at 0x7f94628018a0>'
    'get_to_timestamp_base': None, # (!) real value is '<capsule object "int (int, int __pyx_skip_dispatch)" at 0x7f9462801960>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.frequencies', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f946280d438>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/frequencies.cpython-36m-x86_64-linux-gnu.so')"
