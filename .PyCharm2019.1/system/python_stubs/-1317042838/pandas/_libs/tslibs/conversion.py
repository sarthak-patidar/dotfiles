...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/conversion.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
import pytz as pytz # /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pytz/__init__.py
...
class tzutc(__datetime.tzinfo):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.tz.tz\', \'__doc__\': "\\n    This is a tzinfo object that represents the UTC time zone.\\n\\n    **Examples:**\\n\\n    .. doctest::\\n\\n        >>> from datetime import *\\n        >>> from dateutil.tz import *\\n\\n        >>> datetime.now()\\n        datetime.datetime(2003, 9, 27, 9, 40, 1, 521290)\\n\\n        >>> datetime.now(tzutc())\\n        datetime.datetime(2003, 9, 27, 12, 40, 12, 156379, tzinfo=tzutc())\\n\\n        >>> datetime.now(tzutc()).tzname()\\n        \'UTC\'\\n\\n    .. versionchanged:: 2.7.0\\n        ``tzutc()`` is now a singleton, so the result of ``tzutc()`` will\\n        always return the same object.\\n\\n        .. doctest::\\n\\n            >>> from dateutil.tz import tzutc, UTC\\n            >>> tzutc() is tzutc()\\n            True\\n            >>> tzutc() is UTC\\n            True\\n    ", \'utcoffset\': <function tzutc.utcoffset at 0x7fdea317bf28>, \'dst\': <function tzutc.dst at 0x7fdea317e048>, \'tzname\': <function tzutc.tzname at 0x7fdea317e0d0>, \'is_ambiguous\': <function tzutc.is_ambiguous at 0x7fdea317e158>, \'fromutc\': <function tzutc.fromutc at 0x7fdea317e268>, \'__eq__\': <function tzutc.__eq__ at 0x7fdea317e2f0>, \'__hash__\': None, \'__ne__\': <function tzutc.__ne__ at 0x7fdea317e378>, \'__repr__\': <function tzutc.__repr__ at 0x7fdea317e400>, \'__reduce__\': <method \'__reduce__\' of \'object\' objects>, \'__dict__\': <attribute \'__dict__\' of \'tzutc\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'tzutc\' objects>, \'_TzSingleton__instance\': tzutc()})'
    __hash__ = None
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fdea32698d0>'

__pyx_capi__ = {
    'convert_datetime_to_tsobject': None, # (!) real value is '<capsule object "struct __pyx_obj_6pandas_5_libs_6tslibs_10conversion__TSObject *(PyDateTime_DateTime *, PyObject *, struct __pyx_opt_args_6pandas_5_libs_6tslibs_10conversion_convert_datetime_to_tsobject *__pyx_optional_args)" at 0x7fdea38c7b70>'
    'convert_to_tsobject': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, PyObject *, int, int, struct __pyx_opt_args_6pandas_5_libs_6tslibs_10conversion_convert_to_tsobject *__pyx_optional_args)" at 0x7fdea38c7a80>'
    'get_datetime64_nanos': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (PyObject *)" at 0x7fdea38c7bd0>'
    'localize_pydatetime': None, # (!) real value is '<capsule object "PyDateTime_DateTime *(PyDateTime_DateTime *, PyObject *, int __pyx_skip_dispatch)" at 0x7fdea318d360>'
    'maybe_datetimelike_to_i8': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7fdea38c7c30>'
    'pydt_to_i8': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (PyObject *, int __pyx_skip_dispatch)" at 0x7fdea38c7c00>'
    'tz_convert_single': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (__pyx_t_5numpy_int64_t, PyObject *, PyObject *, int __pyx_skip_dispatch)" at 0x7fdea38c7ba0>'
    'tz_convert_utc_to_tzlocal': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (__pyx_t_5numpy_int64_t, PyDateTime_TZInfo *)" at 0x7fdea38c7c60>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.conversion', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fdea32698d0>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/conversion.cpython-36m-x86_64-linux-gnu.so')"
