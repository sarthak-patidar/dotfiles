...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/parsing.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
...
import six as six # /home/sarthak/IDE/Pycharm/helpers/six.py
...
class relativedelta(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.relativedelta\', \'__doc__\': "\\n    The relativedelta type is designed to be applied to an existing datetime and\\n    can replace specific components of that datetime, or represents an interval\\n    of time.\\n\\n    It is based on the specification of the excellent work done by M.-A. Lemburg\\n    in his\\n    `mx.DateTime <https://www.egenix.com/products/python/mxBase/mxDateTime/>`_ extension.\\n    However, notice that this type does *NOT* implement the same algorithm as\\n    his work. Do *NOT* expect it to behave like mx.DateTime\'s counterpart.\\n\\n    There are two different ways to build a relativedelta instance. The\\n    first one is passing it two date/datetime classes::\\n\\n        relativedelta(datetime1, datetime2)\\n\\n    The second one is passing it any number of the following keyword arguments::\\n\\n        relativedelta(arg1=x,arg2=y,arg3=z...)\\n\\n        year, month, day, hour, minute, second, microsecond:\\n            Absolute information (argument is singular); adding or subtracting a\\n            relativedelta with absolute information does not perform an arithmetic\\n            operation, but rather REPLACES the corresponding value in the\\n            original datetime with the value(s) in relativedelta.\\n\\n        years, months, weeks, days, hours, minutes, seconds, microseconds:\\n            Relative information, may be negative (argument is plural); adding\\n            or subtracting a relativedelta with relative information performs\\n            the corresponding aritmetic operation on the original datetime value\\n            with the information in the relativedelta.\\n\\n        weekday: \\n            One of the weekday instances (MO, TU, etc) available in the\\n            relativedelta module. These instances may receive a parameter N,\\n            specifying the Nth weekday, which could be positive or negative\\n            (like MO(+1) or MO(-2)). Not specifying it is the same as specifying\\n            +1. You can also use an integer, where 0=MO. This argument is always\\n            relative e.g. if the calculated date is already Monday, using MO(1)\\n            or MO(-1) won\'t change the day. To effectively make it absolute, use\\n            it in combination with the day argument (e.g. day=1, MO(1) for first\\n            Monday of the month).\\n\\n        leapdays:\\n            Will add given days to the date found, if year is a leap\\n            year, and the date found is post 28 of february.\\n\\n        yearday, nlyearday:\\n            Set the yearday or the non-leap year day (jump leap days).\\n            These are converted to day/month/leapdays information.\\n\\n    There are relative and absolute forms of the keyword\\n    arguments. The plural is relative, and the singular is\\n    absolute. For each argument in the order below, the absolute form\\n    is applied first (by setting each attribute to that value) and\\n    then the relative form (by adding the value to the attribute).\\n\\n    The order of attributes considered when this relativedelta is\\n    added to a datetime is:\\n\\n    1. Year\\n    2. Month\\n    3. Day\\n    4. Hours\\n    5. Minutes\\n    6. Seconds\\n    7. Microseconds\\n\\n    Finally, weekday is applied, using the rule described above.\\n\\n    For example\\n\\n    >>> from datetime import datetime\\n    >>> from dateutil.relativedelta import relativedelta, MO\\n    >>> dt = datetime(2018, 4, 9, 13, 37, 0)\\n    >>> delta = relativedelta(hours=25, day=1, weekday=MO(1))\\n    >>> dt + delta\\n    datetime.datetime(2018, 4, 2, 14, 37)\\n\\n    First, the day is set to 1 (the first of the month), then 25 hours\\n    are added, to get to the 2nd day and 14th hour, finally the\\n    weekday is applied, but since the 2nd is already a Monday there is\\n    no effect.\\n\\n    ", \'__init__\': <function relativedelta.__init__ at 0x7f4b6a30dbf8>, \'_fix\': <function relativedelta._fix at 0x7f4b6a31d048>, \'weeks\': <property object at 0x7f4b6a2f5c28>, \'_set_months\': <function relativedelta._set_months at 0x7f4b6a31d1e0>, \'normalized\': <function relativedelta.normalized at 0x7f4b6a31d268>, \'__add__\': <function relativedelta.__add__ at 0x7f4b6a31d2f0>, \'__radd__\': <function relativedelta.__radd__ at 0x7f4b6a31d378>, \'__rsub__\': <function relativedelta.__rsub__ at 0x7f4b6a31d400>, \'__sub__\': <function relativedelta.__sub__ at 0x7f4b6a31d488>, \'__abs__\': <function relativedelta.__abs__ at 0x7f4b6a31d510>, \'__neg__\': <function relativedelta.__neg__ at 0x7f4b6a31d598>, \'__bool__\': <function relativedelta.__bool__ at 0x7f4b6a31d620>, \'__nonzero__\': <function relativedelta.__bool__ at 0x7f4b6a31d620>, \'__mul__\': <function relativedelta.__mul__ at 0x7f4b6a31d6a8>, \'__rmul__\': <function relativedelta.__mul__ at 0x7f4b6a31d6a8>, \'__eq__\': <function relativedelta.__eq__ at 0x7f4b6a31d730>, \'__hash__\': <function relativedelta.__hash__ at 0x7f4b6a31d7b8>, \'__ne__\': <function relativedelta.__ne__ at 0x7f4b6a31d840>, \'__div__\': <function relativedelta.__div__ at 0x7f4b6a31d8c8>, \'__truediv__\': <function relativedelta.__div__ at 0x7f4b6a31d8c8>, \'__repr__\': <function relativedelta.__repr__ at 0x7f4b6a31d950>, \'__dict__\': <attribute \'__dict__\' of \'relativedelta\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'relativedelta\' objects>})'
...
class tzoffset(__datetime.tzinfo):
    ...
    _TzOffsetFactory__instances = None # (!) real value is '<WeakValueDictionary at 0x7f4b6a1bb8d0>'
    _TzOffsetFactory__strong_cache = OrderedDict()
    _TzOffsetFactory__strong_cache_size = 8
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'dateutil.tz.tz', '__doc__': '\\n    A simple class for representing a fixed offset from UTC.\\n\\n    :param name:\\n        The timezone name, to be returned when ``tzname()`` is called.\\n    :param offset:\\n        The time zone offset in seconds, or (since version 2.6.0, represented\\n        as a :py:class:`datetime.timedelta` object).\\n    ', '__init__': <function tzoffset.__init__ at 0x7f4b6a1c0488>, 'utcoffset': <function tzoffset.utcoffset at 0x7f4b6a1c0510>, 'dst': <function tzoffset.dst at 0x7f4b6a1c0598>, 'tzname': <function tzoffset.tzname at 0x7f4b6a1c0620>, 'fromutc': <function tzoffset.fromutc at 0x7f4b6a1c0730>, 'is_ambiguous': <function tzoffset.is_ambiguous at 0x7f4b6a1c07b8>, '__eq__': <function tzoffset.__eq__ at 0x7f4b6a1c0840>, '__hash__': None, '__ne__': <function tzoffset.__ne__ at 0x7f4b6a1c08c8>, '__repr__': <function tzoffset.__repr__ at 0x7f4b6a1c0950>, '__reduce__': <method '__reduce__' of 'object' objects>, '__dict__': <attribute '__dict__' of 'tzoffset' objects>, '__weakref__': <attribute '__weakref__' of 'tzoffset' objects>, '_TzOffsetFactory__instances': <WeakValueDictionary at 0x7f4b6a1bb8d0>, '_TzOffsetFactory__strong_cache': OrderedDict(), '_TzOffsetFactory__strong_cache_size': 8})"
    __hash__ = None
...
class _dateutil_tzstr(__dateutil_tz_tz.tzrange):
    ...
    _TzStrFactory__instances = None # (!) real value is '<WeakValueDictionary at 0x7f4b6a1bbc50>'
...
class _dateutil_tzutc(__datetime.tzinfo):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.tz.tz\', \'__doc__\': "\\n    This is a tzinfo object that represents the UTC time zone.\\n\\n    **Examples:**\\n\\n    .. doctest::\\n\\n        >>> from datetime import *\\n        >>> from dateutil.tz import *\\n\\n        >>> datetime.now()\\n        datetime.datetime(2003, 9, 27, 9, 40, 1, 521290)\\n\\n        >>> datetime.now(tzutc())\\n        datetime.datetime(2003, 9, 27, 12, 40, 12, 156379, tzinfo=tzutc())\\n\\n        >>> datetime.now(tzutc()).tzname()\\n        \'UTC\'\\n\\n    .. versionchanged:: 2.7.0\\n        ``tzutc()`` is now a singleton, so the result of ``tzutc()`` will\\n        always return the same object.\\n\\n        .. doctest::\\n\\n            >>> from dateutil.tz import tzutc, UTC\\n            >>> tzutc() is tzutc()\\n            True\\n            >>> tzutc() is UTC\\n            True\\n    ", \'utcoffset\': <function tzutc.utcoffset at 0x7f4b6a1bdf28>, \'dst\': <function tzutc.dst at 0x7f4b6a1c0048>, \'tzname\': <function tzutc.tzname at 0x7f4b6a1c00d0>, \'is_ambiguous\': <function tzutc.is_ambiguous at 0x7f4b6a1c0158>, \'fromutc\': <function tzutc.fromutc at 0x7f4b6a1c0268>, \'__eq__\': <function tzutc.__eq__ at 0x7f4b6a1c02f0>, \'__hash__\': None, \'__ne__\': <function tzutc.__ne__ at 0x7f4b6a1c0378>, \'__repr__\': <function tzutc.__repr__ at 0x7f4b6a1c0400>, \'__reduce__\': <method \'__reduce__\' of \'object\' objects>, \'__dict__\': <attribute \'__dict__\' of \'tzutc\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'tzutc\' objects>, \'_TzSingleton__instance\': tzutc()})'
    __hash__ = None
...
class _timelex(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas._libs.tslibs.parsing', '__init__': <cyfunction _timelex.__init__ at 0x7f4b6a2323e0>, 'get_tokens': <cyfunction _timelex.get_tokens at 0x7f4b6a232498>, 'split': <classmethod object at 0x7f4b6a230eb8>, '__dict__': <attribute '__dict__' of '_timelex' objects>, '__weakref__': <attribute '__weakref__' of '_timelex' objects>, '__doc__': None})"


# variables with complex values

DEFAULTPARSER = None # (!) real value is '<dateutil.parser._parser.parser object at 0x7f4b6a300a58>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4b6a22bc88>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.parsing', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f4b6a22bc88>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/_libs/tslibs/parsing.cpython-36m-x86_64-linux-gnu.so')"
