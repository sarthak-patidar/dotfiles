...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/io/msgpack/_unpacker.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
class ExtType(__pandas_io_msgpack.ExtType):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas.io.msgpack', '__doc__': 'ExtType represents ext type in msgpack.', '__new__': <staticmethod object at 0x7efef400e1d0>, '__dict__': <attribute '__dict__' of 'ExtType' objects>})"
...
class Unpacker(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7efef42f3e10>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7efef400ef60>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas.io.msgpack._unpacker', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efef400ef60>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/io/msgpack/_unpacker.cpython-36m-x86_64-linux-gnu.so')"
