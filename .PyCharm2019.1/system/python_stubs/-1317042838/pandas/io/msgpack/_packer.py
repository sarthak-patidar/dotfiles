...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/io/msgpack/_packer.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
class ExtType(__pandas_io_msgpack.ExtType):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas.io.msgpack', '__doc__': 'ExtType represents ext type in msgpack.', '__new__': <staticmethod object at 0x7f01b3a1c198>, '__dict__': <attribute '__dict__' of 'ExtType' objects>})"
...
class Packer(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f01b3d01db0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f01b3a1ca58>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas.io.msgpack._packer', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f01b3a1ca58>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/io/msgpack/_packer.cpython-36m-x86_64-linux-gnu.so')"
