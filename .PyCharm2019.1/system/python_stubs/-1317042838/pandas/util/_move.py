...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fa30cc75c88>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas.util._move', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fa30cc75c88>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/pandas/util/_move.cpython-36m-x86_64-linux-gnu.so')"
