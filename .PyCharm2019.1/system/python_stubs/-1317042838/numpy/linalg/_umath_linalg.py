...
# from /var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/numpy/linalg/_umath_linalg.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc1e907dfd0>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.linalg._umath_linalg', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc1e907dfd0>, origin='/var/www/newsbytes/CPP/venv/lib/python3.6/site-packages/numpy/linalg/_umath_linalg.cpython-36m-x86_64-linux-gnu.so')"
