...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f5a77cd7710>'

__spec__ = None # (!) real value is "ModuleSpec(name='_csv', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f5a77cd7710>, origin='/usr/lib/python3.6/lib-dynload/_csv.cpython-36m-x86_64-linux-gnu.so')"
