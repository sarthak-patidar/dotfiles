...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb5f6ab6ba8>'

__spec__ = None # (!) real value is "ModuleSpec(name='_ssl', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb5f6ab6ba8>, origin='/usr/lib/python3.6/lib-dynload/_ssl.cpython-36m-x86_64-linux-gnu.so')"
