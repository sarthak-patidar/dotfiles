...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f21df74cba8>'

__spec__ = None # (!) real value is "ModuleSpec(name='cmath', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f21df74cba8>, origin='/usr/lib/python3.6/lib-dynload/cmath.cpython-36m-x86_64-linux-gnu.so')"
