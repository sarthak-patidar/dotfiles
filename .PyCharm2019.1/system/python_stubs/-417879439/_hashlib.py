...
openssl_md_meth_names = None # (!) real value is "frozenset({'SHA384', 'RIPEMD160', 'SHA512', 'MD4', 'sha512', 'SHA', 'dsaWithSHA', 'SHA224', 'MD5', 'SHA256', 'SHA1', 'sha256', 'DSA', 'sha224', 'md4', 'ecdsa-with-SHA1', 'sha1', 'sha', 'sha384', 'ripemd160', 'whirlpool', 'dsaEncryption', 'md5', 'DSA-SHA'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f831252ab70>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f831252ab70>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
