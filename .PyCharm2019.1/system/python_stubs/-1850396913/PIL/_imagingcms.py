...
# from /var/www/newsbytes/CricketPlayerDataScrapper/venv/lib/python3.6/site-packages/PIL/_imagingcms.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fcebf27e9b0>'

__spec__ = None # (!) real value is "ModuleSpec(name='PIL._imagingcms', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fcebf27e9b0>, origin='/var/www/newsbytes/CricketPlayerDataScrapper/venv/lib/python3.6/site-packages/PIL/_imagingcms.cpython-36m-x86_64-linux-gnu.so')"
