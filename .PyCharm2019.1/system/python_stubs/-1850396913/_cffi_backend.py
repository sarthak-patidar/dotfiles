...
# from /var/www/newsbytes/CricketPlayerDataScrapper/venv/lib/python3.6/site-packages/_cffi_backend.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
_C_API = None # (!) real value is '<capsule object "cffi" at 0x7f38bd728c30>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f38bd6d6b70>'

__spec__ = None # (!) real value is "ModuleSpec(name='_cffi_backend', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f38bd6d6b70>, origin='/var/www/newsbytes/CricketPlayerDataScrapper/venv/lib/python3.6/site-packages/_cffi_backend.cpython-36m-x86_64-linux-gnu.so')"
