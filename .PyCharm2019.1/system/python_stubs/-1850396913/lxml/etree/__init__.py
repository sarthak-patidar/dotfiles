...
memory_debugger = None # (!) real value is '<lxml.etree._MemDebug object at 0x7f578d27f630>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f578aa11d68>'

__pyx_capi__ = {
    'adoptExternalDocument': None, # (!) real value is '<capsule object "struct LxmlElementTree *(xmlDoc *, PyObject *, int)" at 0x7f578a4bee40>'
    'appendChild': None, # (!) real value is '<capsule object "void (struct LxmlElement *, struct LxmlElement *)" at 0x7f578a483450>'
    'appendChildToElement': None, # (!) real value is '<capsule object "int (struct LxmlElement *, struct LxmlElement *)" at 0x7f578a483480>'
    'attributeValue': None, # (!) real value is '<capsule object "PyObject *(xmlNode *, xmlAttr *)" at 0x7f578a4831b0>'
    'attributeValueFromNsName': None, # (!) real value is '<capsule object "PyObject *(xmlNode *, const xmlChar *, const xmlChar *)" at 0x7f578a4831e0>'
    'callLookupFallback': None, # (!) real value is '<capsule object "PyObject *(struct LxmlFallbackElementClassLookup *, struct LxmlDocument *, xmlNode *)" at 0x7f578a4bef90>'
    'collectAttributes': None, # (!) real value is '<capsule object "PyObject *(xmlNode *, int)" at 0x7f578a483270>'
    'deepcopyNodeToDocument': None, # (!) real value is '<capsule object "struct LxmlElement *(struct LxmlDocument *, xmlNode *)" at 0x7f578a4bedb0>'
    'delAttribute': None, # (!) real value is '<capsule object "int (struct LxmlElement *, PyObject *)" at 0x7f578a4832d0>'
    'delAttributeFromNsName': None, # (!) real value is '<capsule object "int (xmlNode *, const xmlChar *, const xmlChar *)" at 0x7f578a483300>'
    'documentOrRaise': None, # (!) real value is '<capsule object "struct LxmlDocument *(PyObject *)" at 0x7f578a483030>'
    'elementFactory': None, # (!) real value is '<capsule object "struct LxmlElement *(struct LxmlDocument *, xmlNode *)" at 0x7f578a4bee70>'
    'elementTreeFactory': None, # (!) real value is '<capsule object "struct LxmlElementTree *(struct LxmlElement *)" at 0x7f578a4bede0>'
    'findChild': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *, Py_ssize_t)" at 0x7f578a483360>'
    'findChildBackwards': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *, Py_ssize_t)" at 0x7f578a4833c0>'
    'findChildForwards': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *, Py_ssize_t)" at 0x7f578a483390>'
    'findOrBuildNodeNsPrefix': None, # (!) real value is '<capsule object "xmlNs *(struct LxmlDocument *, xmlNode *, const xmlChar *, const xmlChar *)" at 0x7f578a483630>'
    'getAttributeValue': None, # (!) real value is '<capsule object "PyObject *(struct LxmlElement *, PyObject *, PyObject *)" at 0x7f578a483210>'
    'getNsTag': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7f578a483510>'
    'getNsTagWithEmptyNs': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7f578a483540>'
    'hasChild': None, # (!) real value is '<capsule object "int (xmlNode *)" at 0x7f578a483330>'
    'hasTail': None, # (!) real value is '<capsule object "int (xmlNode *)" at 0x7f578a4830c0>'
    'hasText': None, # (!) real value is '<capsule object "int (xmlNode *)" at 0x7f578a483090>'
    'initTagMatch': None, # (!) real value is '<capsule object "void (struct LxmlElementTagMatcher *, PyObject *)" at 0x7f578a483600>'
    'iteratorStoreNext': None, # (!) real value is '<capsule object "void (struct LxmlElementIterator *, struct LxmlElement *)" at 0x7f578a4835d0>'
    'iterattributes': None, # (!) real value is '<capsule object "PyObject *(struct LxmlElement *, int)" at 0x7f578a483240>'
    'lookupDefaultElementClass': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, xmlNode *)" at 0x7f578a4bef30>'
    'lookupNamespaceElementClass': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, xmlNode *)" at 0x7f578a4bef60>'
    'makeElement': None, # (!) real value is '<capsule object "struct LxmlElement *(PyObject *, struct LxmlDocument *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *)" at 0x7f578a4beea0>'
    'makeSubElement': None, # (!) real value is '<capsule object "struct LxmlElement *(struct LxmlElement *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *)" at 0x7f578a4beed0>'
    'namespacedName': None, # (!) real value is '<capsule object "PyObject *(xmlNode *)" at 0x7f578a483570>'
    'namespacedNameFromNsName': None, # (!) real value is '<capsule object "PyObject *(const xmlChar *, const xmlChar *)" at 0x7f578a4835a0>'
    'newElementTree': None, # (!) real value is '<capsule object "struct LxmlElementTree *(struct LxmlElement *, PyObject *)" at 0x7f578a4bee10>'
    'nextElement': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *)" at 0x7f578a4833f0>'
    'previousElement': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *)" at 0x7f578a483420>'
    'pyunicode': None, # (!) real value is '<capsule object "PyObject *(const xmlChar *)" at 0x7f578a4834b0>'
    'rootNodeOrRaise': None, # (!) real value is '<capsule object "struct LxmlElement *(PyObject *)" at 0x7f578a483060>'
    'setAttributeValue': None, # (!) real value is '<capsule object "int (struct LxmlElement *, PyObject *, PyObject *)" at 0x7f578a4832a0>'
    'setElementClassLookupFunction': None, # (!) real value is '<capsule object "void (_element_class_lookup_function, PyObject *)" at 0x7f578a4bef00>'
    'setNodeText': None, # (!) real value is '<capsule object "int (xmlNode *, PyObject *)" at 0x7f578a483150>'
    'setTailText': None, # (!) real value is '<capsule object "int (xmlNode *, PyObject *)" at 0x7f578a483180>'
    'tagMatches': None, # (!) real value is '<capsule object "int (xmlNode *, const xmlChar *, const xmlChar *)" at 0x7f578a4befc0>'
    'tailOf': None, # (!) real value is '<capsule object "PyObject *(xmlNode *)" at 0x7f578a483120>'
    'textOf': None, # (!) real value is '<capsule object "PyObject *(xmlNode *)" at 0x7f578a4830f0>'
    'utf8': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7f578a4834e0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='lxml.etree', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f578aa11d68>, origin='/var/www/newsbytes/CricketPlayerDataScrapper/venv/lib/python3.6/site-packages/lxml/etree.cpython-36m-x86_64-linux-gnu.so')"
