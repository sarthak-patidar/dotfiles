...
executable = '/var/www/newsbytes/CricketPlayerDataScrapper/venv/bin/python'

exec_prefix = '/var/www/newsbytes/CricketPlayerDataScrapper/venv'
...
prefix = '/var/www/newsbytes/CricketPlayerDataScrapper/venv'
...
path = [
    ...
    '/var/www/newsbytes/CricketPlayerDataScrapper/venv/lib/python3.6/site-packages',
    '/var/www/newsbytes/CricketPlayerDataScrapper/venv/lib/python3.6/site-packages/setuptools-39.1.0-py3.6.egg',
]

path_hooks = [
    None, # (!) real value is "<class 'zipimport.zipimporter'>"
    None, # (!) real value is '<function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0x7ffb5f33d6a8>'
]
