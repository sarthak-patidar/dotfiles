...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f0e1c70ada0>'

__spec__ = None # (!) real value is "ModuleSpec(name='mmap', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f0e1c70ada0>, origin='/usr/lib/python3.6/lib-dynload/mmap.cpython-36m-x86_64-linux-gnu.so')"
