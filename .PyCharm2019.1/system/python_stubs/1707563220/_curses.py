...
_C_API = None # (!) real value is '<capsule object "_curses._C_API" at 0x7f6ab0138e40>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f6ab00f58d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f6ab00f58d0>, origin='/usr/lib/python3.6/lib-dynload/_curses.cpython-36m-x86_64-linux-gnu.so')"
