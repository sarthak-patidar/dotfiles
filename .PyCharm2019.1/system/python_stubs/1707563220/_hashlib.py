...
openssl_md_meth_names = None # (!) real value is "frozenset({'md5', 'dsaEncryption', 'SHA224', 'dsaWithSHA', 'SHA', 'sha256', 'ripemd160', 'SHA512', 'MD4', 'sha224', 'SHA1', 'SHA256', 'RIPEMD160', 'sha', 'SHA384', 'sha384', 'md4', 'whirlpool', 'DSA-SHA', 'sha1', 'sha512', 'MD5', 'ecdsa-with-SHA1', 'DSA'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f2afa9b1898>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f2afa9b1898>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
