...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f9463506898>'

__spec__ = None # (!) real value is "ModuleSpec(name='_asyncio', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f9463506898>, origin='/usr/lib/python3.6/lib-dynload/_asyncio.cpython-36m-x86_64-linux-gnu.so')"
