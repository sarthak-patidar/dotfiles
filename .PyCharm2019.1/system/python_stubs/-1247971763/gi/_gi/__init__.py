...
TYPE_GSTRING = None # (!) real value is '<GType GString (40984400)>'

TYPE_INVALID = None # (!) real value is '<GType invalid (0)>'

_API = None # (!) real value is '<capsule object "gi._API" at 0x7f9a229850f0>'

_PyGObject_API = None # (!) real value is '<capsule object "gobject._PyGObject_API" at 0x7f9a22985090>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f9a2297af60>'

__spec__ = None # (!) real value is "ModuleSpec(name='gi._gi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f9a2297af60>, origin='/usr/lib/python3/dist-packages/gi/_gi.cpython-36m-x86_64-linux-gnu.so')"
