...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f74d173db70>'

__spec__ = None # (!) real value is "ModuleSpec(name='reportlab.lib._rl_accel', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f74d173db70>, origin='/usr/lib/python3/dist-packages/reportlab/lib/_rl_accel.cpython-36m-x86_64-linux-gnu.so')"
