...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f5e09922710>'

__spec__ = None # (!) real value is "ModuleSpec(name='scanext', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f5e09922710>, origin='/usr/lib/python3/dist-packages/scanext.cpython-36m-x86_64-linux-gnu.so')"
