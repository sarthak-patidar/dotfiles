...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f20aec53ac8>'

__spec__ = None # (!) real value is "ModuleSpec(name='PIL._imagingcms', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f20aec53ac8>, origin='/usr/lib/python3/dist-packages/PIL/_imagingcms.cpython-36m-x86_64-linux-gnu.so')"
