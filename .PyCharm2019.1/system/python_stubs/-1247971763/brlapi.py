...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fead87ee710>'

__spec__ = None # (!) real value is "ModuleSpec(name='brlapi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fead87ee710>, origin='/usr/lib/python3/dist-packages/brlapi.cpython-36m-x86_64-linux-gnu.so')"
